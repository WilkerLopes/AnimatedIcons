function createIcons(icon) {
    ...
    var menu_voltar_2 = "<div class='boxIcone'><div class='bar1'></div><div class='bar2'></div><div class='bar3'></div></div>";
    var menu_voltar_3 = "<div class='boxIcone'><div class='bar1'></div><div class='bar2'></div><div class='bar3'></div></div>";
    var menu_fechar = "<div class='boxIcone'><div class='bar1'></div><div class='bar2'></div><div class='bar3'></div></div>";
    var play_pausar = "<div class='boxIcone'><div class='bar1'></div><div class='bar2'></div><div class='bar3'></div></div>";
    ...
    switch (icon) {
        ...
        case "artigo":
            ...
            break;
        case "menu_voltar_2":
            return menu_voltar_2;
            break;
        case "menu_voltar_3":
            return menu_voltar_3;
            break;
        case "menu_fechar":
            return menu_fechar;
            break;
